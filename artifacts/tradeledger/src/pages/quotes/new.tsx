...
import { Trash2, Plus, Info, UserPlus } from "lucide-react";
...
export default function NewQuote() {
  ...
  const isDepositCompliant = Number(formData.depositPercent) <= 10; // NSW standard rule of thumb for this mockup
  ...
  return (
    <Layout>
      ...
      <div className="px-5 pb-[160px] space-y-8 animate-in fade-in slide-in-from-bottom-4">
        ...
        {previewMode === 'internal' && (
          <div className="space-y-6">
            ...
            <section className="space-y-4 pt-4 border-t border-gray-100">
              ...
              <button 
                onClick={addLineItem}
                className="w-full py-4 border-2 border-dashed border-gray-200 rounded-2xl text-gray-500 font-semibold hover:border-gray-300 hover:text-gray-700 transition-colors flex items-center justify-center gap-2"
              >
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs mt-1 opacity-90">
                      {isDepositCompliant 
                        ? "Compliant with state fair trading limits." 
                        : "Warning: Exceeds standard 10% limit for domestic building work in many states. Check local regulations."}
                    </div>
                  </div>
                </div>
              </div>
